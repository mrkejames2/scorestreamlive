...
GAME=$(post "${BASE_URL}/api/games" \
  "{\"name\":\"M11-B Live Broadcast Overlay Demo\",\"home_team_id\":\"${HOME_ID}\",\"away_team_id\":\"${AWAY_ID}\"}")
...
echo "========================================"
echo "ScoreStreamLive M11-B Demo"
echo "========================================"
...
echo ""
echo "Do NOT refresh the overlay during human acceptance."
