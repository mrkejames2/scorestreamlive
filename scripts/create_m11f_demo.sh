...
GAME=$(
  post "${BASE_URL}/api/games" \
    "{\"name\":\"M11-F Match-State Presentation Demo\",\"home_team_id\":\"${HOME_ID}\",\"away_team_id\":\"${AWAY_ID}\"}"
)
...
echo "========================================"
echo "ScoreStreamLive M11-F Match-State Presentation Demo"
echo "========================================"
echo ""
echo "Game ID:"
echo "${GAME_ID}"
...
echo ""
echo "TEST FLOW"
echo "1. Start First Half -> FIRST HALF banner"
echo "2. Score a goal -> M11-E GOAL banner still works"
echo "3. End First Half -> HALFTIME banner with current score"
echo "4. Start Second Half -> SECOND HALF banner"
echo "5. End Game -> FULL TIME banner with final score"
echo ""
echo "Each match-state banner should clear automatically after ~5 seconds."
echo "No browser refresh should be required."
echo "========================================"
