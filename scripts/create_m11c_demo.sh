...
GAME=$(post "${BASE_URL}/api/games" \
  "{\"name\":\"M11-C Broadcast Clock Demo\",\"home_team_id\":\"${HOME_ID}\",\"away_team_id\":\"${AWAY_ID}\"}")
...
echo "========================================"
echo "ScoreStreamLive M11-C Broadcast Clock Demo"
echo "========================================"
...
echo ""
echo "LIVE BROADCAST OVERLAY"
echo "${BASE_URL}/overlay/games/${GAME_ID}"
echo ""
echo "Open the overlay on two devices if possible."
echo "Do not refresh either overlay during acceptance."
